#!/bin/bash
source thongtingmail.cfg
yum install wget -y

wget https://dl.grafana.com/oss/release/grafana-6.7.3-1.x86_64.rpm
yum -y install grafana-6.7.3-1.x86_64.rpm
sleep 2
mv /etc/grafana/grafana.ini /etc/grafana/grafana.ini.bk
sleep 2
...
user =$usernameguimail
# If the password contains # or ; you have to wrap it with triple quotes. Ex """#password;"""
password =$passwordguiemail
;cert_file =
;key_file =
skip_verify = true
from_address = $usernameguimail
from_name = $Tenmailmonitor
